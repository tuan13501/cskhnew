            ...
            <div class="col-12 xl:col-6" style="border-radius:56px; padding:0.3rem; background: linear-gradient(180deg, var(--primary-color), rgba(33, 150, 243, 0) 30%);">
                <div class="h-full w-full m-0 py-6 px-4" style="border-radius:53px; background: linear-gradient(180deg, var(--surface-50) 38.9%, var(--surface-0));">
                    <div class="text-center mb-5">
                        ...
                        <p class="text-600 font-medium">Đăng nhập để tiếp tục</p>
                        <p class="text-600 font-medium">Hoặc  <router-link to="/register" > đăng ký mới </router-link></p>
                    ...
                    <div class="w-full md:w-10 mx-auto">
                        ...
                        <label for="companycode" class="block text-900 font-medium text-xl mb-2">Mã bảo mật</label>
                        <InputNumber id="companycode"  v-model="companycode" placeholder="Mã bảo mật" :toggleMask="true" class="w-full mb-3" inputClass="w-full" inputStyle="padding:1rem" mode="decimal" :useGrouping="false"></InputNumber>

                        <div class="flex align-items-center justify-content-between mb-5">
                            <div class="flex align-items-center">
                                <Checkbox id="rememberme1" v-model="checked" :binary="true" class="mr-2"></Checkbox>
                                <label for="rememberme1">Nhớ tên đăng nhập</label>
                            </div>

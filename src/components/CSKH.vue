          ...
          <TabPanel header="Hóa đơn">
            ...
            >
              ...
              <Column headerStyle="width:1rem">
                <template #body="{ data }" v-if="auth == 'true'">
...
export default {
  ...
  mounted() {
    ...
    this.invoiceService.getInvoiceByCode(this.params.consignmentId, this.params.cusNo).then((data) => (this.invoices = data));
    console.log(this.invoices);
    this.invoiceService
      .getInvoiceDetailByCode(this.params.consignmentId, this.params.cusNo)
